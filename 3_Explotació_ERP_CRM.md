...
a).- Escriviu la seqüència d’instruccions de PostgreSQL que ha d’executar per un superusuari, per crear un usuari anomenat **becari**, amb el mínim conjunt de privilegis que li permeta la lectura sobre totes les taules de l’esquema públic de la base de dades. Fes una captura de com queden els permisos a la base de dades, a l'esquema i a la taula res_users.
b).- Descriviu les accions que ha de portar a terme a pgAdmin un superusuari, per crear un grup d’usuaris anomenat **becaris**, amb el mínim conjunt de privilegis que els permeta la lectura sobre totes les taules de l’esquema public de la base de dades. Procediu a crear dos usuaris **Becari1** i **Becari2** en aquest grup. Fes una captura de com queden els permisos a la base de dades, a l'esquema i a la taula res_users.
